...
class UI {
  ...
  static displayTasks(day) {
    let arr = [..._Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks];

    if (day === "Today") {
      arr = _Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks.filter((obj) => {
