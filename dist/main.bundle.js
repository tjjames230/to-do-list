    ...
    if (day === "Today") {
      ...
      for (let i = 0; i < _Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks.length; i++) {
        if (
          ...
          _Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks[i].dueDate <= UI.getDates("Upcoming")
        ) {
          arr.push(_Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks[i]);
        }
      }
