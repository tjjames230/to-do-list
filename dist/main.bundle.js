...
.task-list .task-headers {
  display: grid;
  grid: auto-flow/12.5rem 6.25rem 1fr 5rem 9.375rem 5rem;
  gap: 0.9375rem;
  padding: 0.625rem;
  align-items: center;
}
...
.task-list .task .task-priority,
.task-list .task-headers .task-priority {
  height: 0.625rem;
  width: 0.625rem;
  border-radius: 0.625rem;
  margin: 0 auto;
...
.task-list .task .low,
.task-list .task-headers .low {
  background-color: green;
}
.task-list .task .medium,
.task-list .task-headers .medium {
  background-color: yellow;
}
.task-list .task .high,
.task-list .task-headers .high {
...
@media screen and (max-width: 1250px) {
  ...
  .task-list .task,
  .task-list .task-headers {
    grid: auto-flow/1fr 6.25rem 5rem 9.375rem 5rem;
  }
}
@media screen and (max-width: 900px) {
  ...
  .task-list .task,
  .task-list .task-headers {
    grid: auto-flow/1fr 6.25rem 9.375rem 5rem;
  }
}
@media screen and (max-width: 600px) {
  ...
  .task-list .task,
  .task-list .task-headers {
    grid: auto-flow/1fr 6.25rem 5rem;
  }
}
...
.form-bg .new-form fieldset {
  padding: 0.3125rem;
}
.form-bg .new-form fieldset legend {
  text-align: center;
  padding: 0 0.9375rem;
}
.form-bg .new-form fieldset div {
  margin: 0.3125rem;
}
...
}`, "",{"version":3,"sources":["webpack://./src/scss/globals/_general.scss","webpack://./src/scss/styles.scss","webpack://./src/scss/globals/_fonts.scss","webpack://./src/scss/globals/_colors.scss","webpack://./src/scss/globals/_reset.scss","webpack://./src/scss/globals/_typography.scss","webpack://./src/scss/utilities/_breakpoints.scss","webpack://./src/scss/components/_aside.scss","webpack://./src/scss/components/_main.scss","webpack://./src/scss/components/_tasks.scss","webpack://./src/scss/components/_header.scss","webpack://./src/scss/components/_form.scss"],"names":[],"mappings":"AAIA;EACC,eAAA;ACHD;;ADMA;EACC,+BETc;EFUd,eAAA;EACA,iCGJa;EHKb,gBAAA;EACA,aAAA;ACHD;;ADMA;EACC;IACC,sBAAA;ECHA;AACF;AGhBA;;;EAGE,sBAAA;AHkBF;;AGfA;EACE,SAAA;EACA,UAAA;EACA,aAAA;AHkBF;;AGfA;;;EAGE,cAAA;EACA,eAAA;AHkBF;;AI/BA;;;EAGE,aAAA;EACA,gBAAA;AJkCF;;AI/BA;EACE,iBAAA;EACA,wBAAA;EACA,wBFZY;AF8Cd;AKhCE;EDLF;IAKI,kBAAA;EJoCF;AACF;;AIjCA;EACE,iBAAA;EACA,qBAAA;EACA,yBFpBc;AFwDhB;;AIjCA;;;EAGE,qBAAA;AJoCF;;AM7DA;EACC,UAAA;EACA,mBAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,cAAA;EACA,mCJPc;EIQd,iBAAA;ANgED;AM9DC;EACC,aAAA;EACA,sBAAA;EACA,aAAA;ANgEF;AM7DC;EACC,mBAAA;EACA,YAAA;EACA,kBAAA;EACA,gBAAA;EACA,uBAAA;EACA,aAAA;EACA,aAAA;EACA,uBAAA;AN+DF;AM5DC;EACC,mCJ9BY;EI+BZ,eAAA;AN8DF;AM3DC;EACC,uBAAA;EACA,aAAA;EACA,sBAAA;EACA,aAAA;AN6DF;;AMzDA;EACC;IACC,kBAAA;EN4DA;AACF;AMzDA;EACC;IACC,aAAA;IACA,WAAA;IACA,gBAAA;EN2DA;AACF;AO9GA;EACC,UAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,cAAA;EACA,sBAAA;APgHD;;AO7GA;EACC;IACC,WAAA;EPgHA;AACF;AQ7HA;EACC,aAAA;EACA,sBAAA;EACA,aAAA;EACA,UAAA;AR+HD;AQ7HC;EACC,gBAAA;EACA,2BAAA;AR+HF;AQ5HC;EACC,8BAAA;AR8HF;AQ5HE;EACC,gBAAA;AR8HH;AQ5HG;EACC,YAAA;EACA,WAAA;AR8HJ;AQzHC;;EAEC,aAAA;EACA,sDAAA;EACA,cAAA;EACA,iBAAA;EACA,mBAAA;AR2HF;AQzHE;;;;;;EAGC,kBAAA;AR8HH;AQ3HE;;EACC,kBAAA;AR8HH;AQ3HE;;EACC,eAAA;EACA,qCAAA;EACA,YAAA;AR8HH;AQ3HE;;EACC,YAAA;AR8HH;AQ3HE;;EACC,gBAAA;EACA,mBAAA;EACA,uBAAA;AR8HH;AQ3HE;;EACC,gBAAA;EACA,mBAAA;EACA,uBAAA;AR8HH;AQ3HE;;EACC,gBAAA;EACA,mBAAA;EACA,uBAAA;AR8HH;AQ3HE;;EACC,gBAAA;EACA,eAAA;EACA,uBAAA;EACA,cAAA;AR8HH;AQ3HE;;EACC,uBAAA;AR8HH;AQ3HE;;EACC,wBAAA;AR8HH;AQ3HE;;EACC,qBAAA;AR8HH;;AQzHA;EACC;;IAEC,aAAA;ER4HA;EQxHA;;IAEC,8CAAA;ER0HD;AACF;AQtHA;EACC;;IAEC,aAAA;ERwHA;EQpHA;;IAEC,yCAAA;ERsHD;AACF;AQlHA;EACC;;IAEC,aAAA;ERoHA;EQhHA;;IAEC,gCAAA;ERkHD;AACF;AQ9GA;EACC;;IAEC,aAAA;ERgHA;EQ5GA;;IAEC,wBAAA;ER8GD;AACF;AS7PA;EACC,aAAA;EACA,8BAAA;EACA,kBAAA;EACA,mBAAA;EACA,2BAAA;AT+PD;AS7PC;EACC,YAAA;EACA,gBAAA;AT+PF;AS5PC;EACC,aAAA;EACA,sBAAA;EACA,cAAA;EACA,uBAAA;EACA,mBAAA;EACA,gBAAA;EACA,eAAA;EACA,gBAAA;EACA,YAAA;EACA,wBAAA;AT8PF;AS5PE;EACC,uBAAA;EACA,iBAAA;EACA,UAAA;EACA,wBAAA;AT8PH;AS1PC;EACC,eAAA;AT4PF;;ASxPA;EACC;IACC,aAAA;ET2PA;AACF;AUnSA;EACC,UAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,YAAA;EACA,kBAAA;EACA,QAAA;EACA,MAAA;EACA,UAAA;EACA,sCAAA;AVqSD;AUnSC;EACC,uBAAA;EACA,kBAAA;EACA,wBAAA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;AVqSF;AUnSE;EACC,aAAA;EACA,sBAAA;AVqSH;AUlSE;EACC,kBAAA;AVoSH;AUlSG;EACC,kBAAA;EACA,oBAAA;AVoSJ;AUjSG;EACC,iBAAA;AVmSJ;;AU7RA;EACC;IACC,6BAAA;EVgSA;AACF;AU7RA;EACC;IACC,6BAAA;EV+RA;AACF;AU5RA;EACC;IACC,eAAA;IACA,WAAA;EV8RA;AACF","sourcesContent":["@use \"../utilities/\" as *;\n@use \"colors\" as *;\n@use \"fonts\" as *;\n\nhtml {\n\tfont-size: 100%;\n}\n\nbody {\n\tfont-family: $font-primary;\n\tfont-size: rem(16);\n\tbackground-color: $clr-gray-lt;\n\tline-height: 1.5;\n\tdisplay: flex;\n}\n\n@media screen and (max-width: 768px) {\n\tbody {\n\t\tflex-direction: column;\n\t}\n}\n","html {\n  font-size: 100%;\n}\n\nbody {\n  font-family: \"Inter\", sans-serf;\n  font-size: 1rem;\n  background-color: hsl(0, 0%, 95%);\n  line-height: 1.5;\n  display: flex;\n}\n\n@media screen and (max-width: 768px) {\n  body {\n    flex-direction: column;\n  }\n}\n*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  font: inherit;\n}\n\nimg,\npicture,\nsvg {\n  display: block;\n  max-width: 100%;\n}\n\nh1,\nh2,\nh3 {\n  margin-top: 0;\n  line-height: 1.1;\n}\n\nh1 {\n  font-size: 1.5rem;\n  margin-bottom: 0.1875rem;\n  color: hsl(11, 55%, 72%);\n}\n@media (min-width: 71.875em) {\n  h1 {\n    font-size: 1.75rem;\n  }\n}\n\nh2 {\n  font-size: 1.5rem;\n  margin-bottom: 1.5rem;\n  color: hsl(51, 100%, 53%);\n}\n\na,\na:visited,\na:active {\n  text-decoration: none;\n}\n\naside {\n  width: 20%;\n  min-width: 18.75rem;\n  padding: 1.5625rem;\n  display: flex;\n  flex-direction: column;\n  gap: 2.8125rem;\n  background-color: hsl(44, 30%, 85%);\n  min-height: 100vh;\n}\naside .aside-flex {\n  display: flex;\n  flex-direction: column;\n  gap: 0.625rem;\n}\naside button {\n  font-size: 0.875rem;\n  border: none;\n  padding: 0.3125rem;\n  background: none;\n  border-radius: 0.625rem;\n  display: flex;\n  gap: 0.625rem;\n  padding-left: 0.9375rem;\n}\naside button:hover {\n  background-color: hsl(11, 55%, 72%);\n  cursor: pointer;\n}\naside #project-ctn {\n  padding-left: 0.9375rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.625rem;\n}\n\n@media screen and (max-width: 1200px) {\n  aside {\n    min-width: 12.5rem;\n  }\n}\n@media screen and (max-width: 768px) {\n  aside {\n    display: none;\n    width: 100%;\n    min-height: auto;\n  }\n}\nmain {\n  width: 80%;\n  padding: 1.5625rem;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 2.8125rem;\n  background-color: gray;\n}\n\n@media screen and (max-width: 768px) {\n  main {\n    width: 100%;\n  }\n}\n.task-list {\n  display: flex;\n  flex-direction: column;\n  gap: 0.625rem;\n  width: 90%;\n}\n.task-list .task-headers {\n  font-weight: 700;\n  background-color: lightblue;\n}\n.task-list .task {\n  border-bottom: 1px solid black;\n}\n.task-list .task button {\n  background: none;\n}\n.task-list .task button i {\n  height: 100%;\n  width: 100%;\n}\n.task-list .task,\n.task-list .task-headers {\n  display: grid;\n  grid: auto-flow/12.5rem 6.25rem 1fr 5rem 9.375rem 5rem;\n  gap: 0.9375rem;\n  padding: 0.625rem;\n  align-items: center;\n}\n.task-list .task h5,\n.task-list .task p,\n.task-list .task i,\n.task-list .task-headers h5,\n.task-list .task-headers p,\n.task-list .task-headers i {\n  text-align: center;\n}\n.task-list .task i,\n.task-list .task-headers i {\n  padding: 0.3125rem;\n}\n.task-list .task i:hover,\n.task-list .task-headers i:hover {\n  cursor: pointer;\n  background-color: hsl(120, 100%, 50%);\n  color: white;\n}\n.task-list .task .task-complete,\n.task-list .task-headers .task-complete {\n  border: none;\n}\n.task-list .task .task-title,\n.task-list .task-headers .task-title {\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n}\n.task-list .task .task-description,\n.task-list .task-headers .task-description {\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n}\n.task-list .task .task-project,\n.task-list .task-headers .task-project {\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n}\n.task-list .task .task-priority,\n.task-list .task-headers .task-priority {\n  height: 0.625rem;\n  width: 0.625rem;\n  border-radius: 0.625rem;\n  margin: 0 auto;\n}\n.task-list .task .low,\n.task-list .task-headers .low {\n  background-color: green;\n}\n.task-list .task .medium,\n.task-list .task-headers .medium {\n  background-color: yellow;\n}\n.task-list .task .high,\n.task-list .task-headers .high {\n  background-color: red;\n}\n\n@media screen and (max-width: 1250px) {\n  #task-description-header,\n  .task-description {\n    display: none;\n  }\n  .task-list .task,\n  .task-list .task-headers {\n    grid: auto-flow/1fr 6.25rem 5rem 9.375rem 5rem;\n  }\n}\n@media screen and (max-width: 900px) {\n  #task-priority-header,\n  .task-priority {\n    display: none;\n  }\n  .task-list .task,\n  .task-list .task-headers {\n    grid: auto-flow/1fr 6.25rem 9.375rem 5rem;\n  }\n}\n@media screen and (max-width: 600px) {\n  #task-project-header,\n  .task-project {\n    display: none;\n  }\n  .task-list .task,\n  .task-list .task-headers {\n    grid: auto-flow/1fr 6.25rem 5rem;\n  }\n}\n@media screen and (max-width: 500px) {\n  #task-date-header,\n  .task-date {\n    display: none;\n  }\n  .task-list .task,\n  .task-list .task-headers {\n    grid: auto-flow/1fr 5rem;\n  }\n}\nheader {\n  display: none;\n  justify-content: space-between;\n  padding: 1.5625rem;\n  align-items: center;\n  background-color: lightblue;\n}\nheader h1 {\n  color: black;\n  font-weight: 700;\n}\nheader button {\n  display: flex;\n  flex-direction: column;\n  gap: 0.4375rem;\n  justify-content: center;\n  align-items: center;\n  height: 3.125rem;\n  width: 3.125rem;\n  background: none;\n  border: none;\n  border-radius: 0.3125rem;\n}\nheader button div {\n  background-color: black;\n  height: 0.3125rem;\n  width: 75%;\n  border-radius: 0.3125rem;\n}\nheader button:hover {\n  cursor: pointer;\n}\n\n@media screen and (max-width: 768px) {\n  header {\n    display: flex;\n  }\n}\n.form-bg {\n  z-index: 1;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 80%;\n  background-color: hsla(0, 0%, 0%, 0.7);\n}\n.form-bg .new-form {\n  background-color: white;\n  padding: 1.5625rem;\n  border-radius: 1.5625rem;\n  display: flex;\n  flex-direction: column;\n  gap: 1.25rem;\n}\n.form-bg .new-form .input-ctn {\n  display: flex;\n  flex-direction: column;\n}\n.form-bg .new-form fieldset {\n  padding: 0.3125rem;\n}\n.form-bg .new-form fieldset legend {\n  text-align: center;\n  padding: 0 0.9375rem;\n}\n.form-bg .new-form fieldset div {\n  margin: 0.3125rem;\n}\n\n@media screen and (max-width: 1500px) {\n  .form-bg {\n    max-width: calc(100% - 300px);\n  }\n}\n@media screen and (max-width: 1200px) {\n  .form-bg {\n    max-width: calc(100% - 200px);\n  }\n}\n@media screen and (max-width: 768px) {\n  .form-bg {\n    max-width: 100%;\n    width: 100%;\n  }\n}","$font-primary: \"Inter\", sans-serf;\n","// Primary Colors\n$clr-primary: hsl(11, 55%, 72%);\n$clr-secondary: hsl(51, 100%, 53%);\n$clr-tertiary: hsl(44, 30%, 85%);\n\n// Neutral Colors\n$clr-white: hsl(0, 0%, 100%);\n$clr-gray-lt: hsl(0, 0%, 95%);\n$clr-gray: hsl(0, 0%, 50%);\n$clr-gray-dk: hsl(0, 0%, 15%);\n$clr-black: hsl(0, 0%, 0%);\n","*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  font: inherit;\n}\n\nimg,\npicture,\nsvg {\n  display: block;\n  max-width: 100%;\n}\n","@use \"../utilities/\" as *;\n@use \"colors\" as *;\n\nh1,\nh2,\nh3 {\n  margin-top: 0;\n  line-height: 1.1;\n}\n\nh1 {\n  font-size: rem(24);\n  margin-bottom: rem(3);\n  color: $clr-primary;\n  @include breakpoint(large) {\n    font-size: rem(28);\n  }\n}\n\nh2 {\n  font-size: rem(24);\n  margin-bottom: rem(24);\n  color: $clr-secondary;\n}\n\na,\na:visited,\na:active {\n  text-decoration: none;\n}\n","// 640px, 1150px, 1400px\n$breakpoints-up: (\n  \"medium\": \"40em\",\n  \"large\": \"71.875em\",\n  \"xlarge\": \"87.5em\",\n);\n\n// 639px, 1149px, 1399px\n$breakpoints-down: (\n  \"small\": \"39.9375em\",\n  \"medium\": \"71.8125em\",\n  \"large\": \"87.4375em\",\n);\n\n@mixin breakpoint($size) {\n  @media (min-width: map-get($breakpoints-up, $size)) {\n    @content;\n  }\n}\n\n@mixin breakpoint-down($size) {\n  @media (max-width: map-get($breakpoints-down, $size)) {\n    @content;\n  }\n}\n","@use \"../utilities/\" as *;\n@use \"../globals/\" as *;\n\naside {\n\twidth: 20%;\n\tmin-width: rem(300);\n\tpadding: rem(25);\n\tdisplay: flex;\n\tflex-direction: column;\n\tgap: rem(45);\n\tbackground-color: $clr-tertiary;\n\tmin-height: 100vh;\n\n\t.aside-flex {\n\t\tdisplay: flex;\n\t\tflex-direction: column;\n\t\tgap: rem(10);\n\t}\n\n\tbutton {\n\t\tfont-size: rem(14);\n\t\tborder: none;\n\t\tpadding: rem(5);\n\t\tbackground: none;\n\t\tborder-radius: rem(10);\n\t\tdisplay: flex;\n\t\tgap: rem(10);\n\t\tpadding-left: rem(15);\n\t}\n\n\tbutton:hover {\n\t\tbackground-color: $clr-primary;\n\t\tcursor: pointer;\n\t}\n\n\t#project-ctn {\n\t\tpadding-left: rem(15);\n\t\tdisplay: flex;\n\t\tflex-direction: column;\n\t\tgap: rem(10);\n\t}\n}\n\n@media screen and (max-width: 1200px) {\n\taside {\n\t\tmin-width: rem(200);\n\t}\n}\n\n@media screen and (max-width: 768px) {\n\taside {\n\t\tdisplay: none;\n\t\twidth: 100%;\n\t\tmin-height: auto;\n\t}\n}\n","@use \"../utilities/\" as *;\n@use \"../globals/\" as *;\n\nmain {\n\twidth: 80%;\n\tpadding: rem(25);\n\tdisplay: flex;\n\tflex-direction: column;\n\talign-items: center;\n\tgap: rem(45);\n\tbackground-color: gray;\n}\n\n@media screen and (max-width: 768px) {\n\tmain {\n\t\twidth: 100%;\n\t}\n}\n","@use \"../utilities/\" as *;\n@use \"../globals/\" as *;\n\n.task-list {\n\tdisplay: flex;\n\tflex-direction: column;\n\tgap: rem(10);\n\twidth: 90%;\n\n\t.task-headers {\n\t\tfont-weight: 700;\n\t\tbackground-color: lightblue;\n\t}\n\n\t.task {\n\t\tborder-bottom: 1px solid black;\n\n\t\tbutton {\n\t\t\tbackground: none;\n\n\t\t\ti {\n\t\t\t\theight: 100%;\n\t\t\t\twidth: 100%;\n\t\t\t}\n\t\t}\n\t}\n\n\t.task,\n\t.task-headers {\n\t\tdisplay: grid;\n\t\tgrid: auto-flow / rem(200) rem(100) 1fr rem(80) rem(150) rem(80);\n\t\tgap: rem(15);\n\t\tpadding: rem(10);\n\t\talign-items: center;\n\n\t\th5,\n\t\tp,\n\t\ti {\n\t\t\ttext-align: center;\n\t\t}\n\n\t\ti {\n\t\t\tpadding: rem(5);\n\t\t}\n\n\t\ti:hover {\n\t\t\tcursor: pointer;\n\t\t\tbackground-color: hsl(120, 100%, 50%);\n\t\t\tcolor: white;\n\t\t}\n\n\t\t.task-complete {\n\t\t\tborder: none;\n\t\t}\n\n\t\t.task-title {\n\t\t\toverflow: hidden;\n\t\t\twhite-space: nowrap;\n\t\t\ttext-overflow: ellipsis;\n\t\t}\n\n\t\t.task-description {\n\t\t\toverflow: hidden;\n\t\t\twhite-space: nowrap;\n\t\t\ttext-overflow: ellipsis;\n\t\t}\n\n\t\t.task-project {\n\t\t\toverflow: hidden;\n\t\t\twhite-space: nowrap;\n\t\t\ttext-overflow: ellipsis;\n\t\t}\n\n\t\t.task-priority {\n\t\t\theight: rem(10);\n\t\t\twidth: rem(10);\n\t\t\tborder-radius: rem(10);\n\t\t\tmargin: 0 auto;\n\t\t}\n\n\t\t.low {\n\t\t\tbackground-color: green;\n\t\t}\n\n\t\t.medium {\n\t\t\tbackground-color: yellow;\n\t\t}\n\n\t\t.high {\n\t\t\tbackground-color: red;\n\t\t}\n\t}\n}\n\n@media screen and (max-width: 1250px) {\n\t#task-description-header,\n\t.task-description {\n\t\tdisplay: none;\n\t}\n\n\t.task-list {\n\t\t.task,\n\t\t.task-headers {\n\t\t\tgrid: auto-flow / 1fr rem(100) rem(80) rem(150) rem(80);\n\t\t}\n\t}\n}\n\n@media screen and (max-width: 900px) {\n\t#task-priority-header,\n\t.task-priority {\n\t\tdisplay: none;\n\t}\n\n\t.task-list {\n\t\t.task,\n\t\t.task-headers {\n\t\t\tgrid: auto-flow / 1fr rem(100) rem(150) rem(80);\n\t\t}\n\t}\n}\n\n@media screen and (max-width: 600px) {\n\t#task-project-header,\n\t.task-project {\n\t\tdisplay: none;\n\t}\n\n\t.task-list {\n\t\t.task,\n\t\t.task-headers {\n\t\t\tgrid: auto-flow / 1fr rem(100) rem(80);\n\t\t}\n\t}\n}\n\n@media screen and (max-width: 500px) {\n\t#task-date-header,\n\t.task-date {\n\t\tdisplay: none;\n\t}\n\n\t.task-list {\n\t\t.task,\n\t\t.task-headers {\n\t\t\tgrid: auto-flow / 1fr rem(80);\n\t\t}\n\t}\n}\n","@use \"../utilities/\" as *;\n@use \"../globals/\" as *;\n\nheader {\n\tdisplay: none;\n\tjustify-content: space-between;\n\tpadding: rem(25);\n\talign-items: center;\n\tbackground-color: lightblue;\n\n\th1 {\n\t\tcolor: black;\n\t\tfont-weight: 700;\n\t}\n\n\tbutton {\n\t\tdisplay: flex;\n\t\tflex-direction: column;\n\t\tgap: rem(7);\n\t\tjustify-content: center;\n\t\talign-items: center;\n\t\theight: rem(50);\n\t\twidth: rem(50);\n\t\tbackground: none;\n\t\tborder: none;\n\t\tborder-radius: rem(5);\n\n\t\tdiv {\n\t\t\tbackground-color: black;\n\t\t\theight: rem(5);\n\t\t\twidth: 75%;\n\t\t\tborder-radius: rem(5);\n\t\t}\n\t}\n\n\tbutton:hover {\n\t\tcursor: pointer;\n\t}\n}\n\n@media screen and (max-width: 768px) {\n\theader {\n\t\tdisplay: flex;\n\t}\n}\n","@use \"../utilities/\" as *;\n@use \"../globals/\" as *;\n\n.form-bg {\n\tz-index: 1;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n\theight: 100%;\n\tposition: absolute;\n\tright: 0;\n\ttop: 0;\n\twidth: 80%;\n\tbackground-color: hsla(0, 0%, 0%, 0.7);\n\n\t.new-form {\n\t\tbackground-color: white;\n\t\tpadding: rem(25);\n\t\tborder-radius: rem(25);\n\t\tdisplay: flex;\n\t\tflex-direction: column;\n\t\tgap: rem(20);\n\n\t\t.input-ctn {\n\t\t\tdisplay: flex;\n\t\t\tflex-direction: column;\n\t\t}\n\n\t\tfieldset {\n\t\t\tpadding: rem(5);\n\n\t\t\tlegend {\n\t\t\t\ttext-align: center;\n\t\t\t\tpadding: 0 rem(15);\n\t\t\t}\n\n\t\t\tdiv {\n\t\t\t\tmargin: rem(5);\n\t\t\t}\n\t\t}\n\t}\n}\n\n@media screen and (max-width: 1500px) {\n\t.form-bg {\n\t\tmax-width: calc(100% - 300px);\n\t}\n}\n\n@media screen and (max-width: 1200px) {\n\t.form-bg {\n\t\tmax-width: calc(100% - 200px);\n\t}\n}\n\n@media screen and (max-width: 768px) {\n\t.form-bg {\n\t\tmax-width: 100%;\n\t\twidth: 100%;\n\t}\n}\n"],"sourceRoot":""}]);
// Exports
...
class Project {
	...
	addProject() {
		...
		_Storage__WEBPACK_IMPORTED_MODULE_0__.MyStorage.setProjectStorage(stringAllProjects);
		console.log();
	}
}
...
class Task {
	...
	deleteTask() {
		...
		_Storage__WEBPACK_IMPORTED_MODULE_0__.MyStorage.setTaskStorage(updatedLocalTasks);
	...
	addTask() {
		...
		_Storage__WEBPACK_IMPORTED_MODULE_0__.MyStorage.setTaskStorage(stringAllTasks);
	}
}
...
class UI {
	...
	static handleTaskSubmit(formCtn) {
		...
		submitBtn.addEventListener("click", (e) => {
			...
			const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(year, month - 1, day), "MM/dd/yyyy");
			...
			if (
				...
				const task = new _Tasks__WEBPACK_IMPORTED_MODULE_0__.Task(title, dueDate, priority, description, project);
				task.addTask();
				main.removeChild(formCtn);
				UI.newTaskWindowOpen = false;
	...
	static displayTasks(day) {
		...
		if (day === "Today") {
			for (let i = 0; i < _Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks.length; i++) {
				if (_Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks[i].dueDate === UI.getDates("Today")) {
					arr.push(_Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks[i]);
				}
			}
			...
			for (let i = 0; i < _Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks.length; i++) {
				if (
					_Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks[i].dueDate >= UI.getDates("Today") &&
					_Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks[i].dueDate <= UI.getDates("Week")
				) {
					arr.push(_Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks[i]);
				}
			}
			...
			UI.createTask(_Tasks__WEBPACK_IMPORTED_MODULE_0__.allTasks);
		}
