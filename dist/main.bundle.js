...
class UI {
  ...
  static handleTaskSubmit() {
    ...
    submitBtn.addEventListener("click", (e) => {
      ...
      if (title !== "" && dueDate !== "") {
        const task = new _Tasks__WEBPACK_IMPORTED_MODULE_0__.Task(title);
      }
    });
  }
